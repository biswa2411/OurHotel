...
const TopContent = (props) => {
  return (
    <div
      className={`font-nunito h-${props.height} bg-[url("https://rare-gallery.com/uploads/posts/568536-dark-hotel.jpg")] bg-cover  py-[250px] uppercase text-white  flex flex-col justify-center  items-center `}
      style={{
